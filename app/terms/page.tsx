  ...
  return (
    <main className="standard-page">
      <div className="standard-page__inner">
        ...
        <section><h2>1. Using Dr Checker</h2><p>Dr Checker provides a free tool to estimate the Domain Rating (DR) of websites. You&apos;re welcome to use it for personal, business, or research purposes. You agree not to misuse the tool by attempting to overload our servers, scrape data at scale without permission, or use the service for any illegal purpose.</p></section>
        <section><h2>2. No Guarantee of Accuracy</h2><p>Domain Rating scores provided by Dr Checker are estimates based on available data and our own methodology. We do not guarantee that scores are 100% accurate, complete, or match results from other tools.</p></section>
