    ...
    <main className="standard-page">
      <div className="standard-page__inner">
        ...
        <section>
          ...
          <p>If you&apos;ve ever done SEO work, link building, or even just wanted to check how strong a website looks before reaching out for a partnership, you know that domain rating tools can be expensive, slow, or buried inside huge platforms you don&apos;t need. We wanted something simple: type a domain, get a score, done. That&apos;s Dr Checker.</p>
        </section>

        <section>
          <h2>What Is Domain Rating?</h2>
          <p>Domain Rating (DR) is a score from 0 to 100 that estimates the overall strength of a website&apos;s backlink profile. The higher the number, the more authority a site tends to carry in the eyes of search engines, at least based on the links pointing to it. It&apos;s a handy way to quickly compare websites at a glance.</p>
        </section>
